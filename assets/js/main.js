...
const contactForm = document.getElementById('contact-form'),
      ...
      contactProject = document.getElementById('user-project'),
      userTextArea = document.getElementById('user-textarea'),
      contactMessage = document.getElementById('contact-message')


const sendEmail =(e) =>{
    e.preventDefault();
    if(contactName.value === '' || contactEmail.value ==='' || contactProject.value ==='' || userTextArea.value === ''){
        // add or remove color
